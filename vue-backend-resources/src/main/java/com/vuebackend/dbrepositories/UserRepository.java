...
public interface UserRepository extends CrudRepository<User, Long> {
    ...
    @Query("SELECT e FROM Endpoint e WHERE e.user.id = (SELECT id FROM User u WHERE u.username = :username)")
    public Iterable<Endpoint> getAllEndpoints(@Param("username") String username);
